    ...
    User.find({ email: req.user.email }).then(result => {
      if (result) {
        if (result.admin === "false") {
          ...
          if (req.body.city) packageDetails.city = req.body.city;
          if (req.body.country) packageDetails.country = req.body.country;
          if (req.body.capacity) packageDetails.capacity = req.body.capacity;
          if (req.body.discountCost)
            packageDetails.discountCost = req.body.discountCost;
          if (req.body.tourCost) packageDetails.tourCost = req.body.tourCost;
          if (req.body.startDate) packageDetails.startDate = req.body.startDate;
          if (req.body.endDate) packageDetails.endDate = req.body.endDate;
          if (req.body.overview) packageDetails.overview = req.body.overview;

          //here will be findoneAndUpdate method with search packagename and update it
